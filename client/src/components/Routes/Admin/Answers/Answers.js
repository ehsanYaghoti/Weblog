...
import FilterAnswerRow from 'src/components/Layouts/Admin/Answer/filterAnswerRow';
import TableAnswer from 'src/components/Layouts/Admin/Answer/TableAnswer';
...
function Answers(props) {
    ...
    useEffect(() => {
        ...
        NodejsApi(`/admin/answers?${queryString}`)
        .then(response => {
    ...
    let deleteHandler = (e , id) =>{
        ...
        NodejsApi.delete(`/admin/answers/${id}`)
        .then(response => { 
    ...
    let approveHandler = (e , id) =>{
        setLoading(true)
        NodejsApi.put(`/admin/answers/${id}/approve`)
        .then(response => { 
                console.log(response)
                setAnswers(response.data.data.docs)  
        })
        .catch(err => console.log(err))
        setLoading(false)
    }
            ...
            <div className='dashborad-body dark:bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] dark:from-gray-700 dark:via-gray-900 dark:to-black'>
                    ...
                    <FilterAnswerRow  />
                {
                    ...
                    (
                        ...
                        :
                        <>
                        <TableContext.Provider value={{  answers  , deleteHandler , sortHandler , approveHandler }}>
                            <TableAnswer />
